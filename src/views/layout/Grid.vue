        ...
        <div class="demo-preview is-padding-middle-8">
          <div :data-container="gridContainer">
            <div :data-grid="[gridAlign, gridGutter].join(' ')" class="demo-grid demo-bg">
              <div
                :data-col="
                  [col.size + col.sizeBreakpoint, col.offset > 0 ? '+' + col.offset + col.offsetBreakpoint : ''].join(
                    ' '
                  )
                "
              ...
              >
                <div class="is-theme is-padding-center-3 is-padding-top-5 is-padding-bottom-2 is-margin-middle-2">
          ...
          <div class="is-absolute is-placed-s">
            <a @click.prevent="addCol" class="btn btn_square btn_big btn_invert is-elevated-16 hover:is-elevated-4">
              <svg class="ixo">
                <use xlink:href="#add" />
              </svg>
            </a>
