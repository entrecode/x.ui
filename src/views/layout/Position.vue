<template>
  <section>
    <div class="demo-bg is-relative is-height-vh-golden">
      <div class="is-theme has-padding-5 has-radius is-elevated-24" style="max-width: 320px;" :class="isPosition + ' ' + isPlaced + '-' + orientation + ' is-layer-' + isLayer">
        <code class="demo-code has-margin-bottom-5" v-text="isPosition + ' ' + isPlaced + '-' + orientation + ' is-layer-' + isLayer"></code>
