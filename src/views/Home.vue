  ...
  <section>
    <div style="background-color: var(--link);">
      <div class="has-padding-8 has-margin-bottom-8 demo-texture is-theme-invert align-center has-width-vw-full has-height-vw-golden" data-flex="center center-items column">
        ...
        <div data-grid="is-center">
          ...
          <div data-col="fit">
            <h2 class="align-center is-ink-highlight">semantic</h2>
          </div>
          <div data-col="fit">
            <h2 class="align-center is-ink-highlight">adaptive</h2>
          </div>
        </div>
      </div>
    </div>
    ...
    <div data-container style="max-width: 800px;">
      <p class="is-lead is-hyphen-block">
        <strong>x.ui</strong> is a framework based on the atomic
      ...
      <p class="is-hyphen-block">
        the goal of
        <strong>x.ui</strong> is to translate the atomic
        ...
        conventions and front-end development.
      </p>
      ...
      <div data-grid>
        <div data-col="3-sm">
          ...
          <p class="is-hyphen-block">
            ...
            <strong>x.ui</strong>. Atoms are
            elements like type, headings, inputs, buttons and more. Atoms only have one
            function. Most atoms have specific modifiers that change attributes like size,
            style or color.
          </p>
        </div>
        <div data-col="3-sm">
          ...
          <p class="is-hyphen-block">
            ...
            fundamental units of a compound. molecules group connected information and/or
            interactions.
          </p>
        </div>
        <div data-col="3-sm">
